 ...
 function  HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn( 
        '  fixed top-0 size-full overflow-hidden bg-neutral-900',
        className
      )}
      {...props}>
            ...
            {Array.from({ length: gridDimensions.columns }).map((_, colIndex) => (
              <div
                ...
                className={cn(
                  ...
                  "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full dark:before:bg-neutral-950  before:opacity-100 before:transition-all before:duration-1000",
                  "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] after:bg-neutral-950 ",
